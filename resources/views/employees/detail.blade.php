                            ...
                            <div class="card-body pt-4">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-60 symbol-xxl-90 mr-5 align-self-start align-self-xxl-center">
                                        <div class="symbol-label">    <img src="{{ $employees->photo }}" class="img-thumbnail max-w-100px" /> </div>
                                        {{-- <div class="symbol-label" style="background-image:url('assets/media/users/150-11.jpg')"></div> --}}
                                        <i class="symbol-badge bg-success"></i>
                                    </div>
                                    <div>
                                        <a href="#" class="font-weight-bolder font-size-h5 text-dark-75 text-hover-primary">{{$employees->fname}} {{$employees->lname}}</a>
                                ...
                                <div class="py-8">
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <span class="text-muted font-weight-bold">{{$employees->contact_no}}</span>
                                    </div>
                                    <div class="d-flex align-items-center mb-2">
                                        <span class="flex-shrink-0 mr-2">
                                            <span class="svg-icon svg-icon-md">
                                        ...
                                        <a href="#" class="text-muted text-hover-primary font-weight-bold">{{$employees->email_add}}</a>
                                    </div>
                                    <div class="d-flex align-items-center mb-2">
                                        <span class="flex-shrink-0 mr-2">
                                            <span class="svg-icon svg-icon-md">
                                        ...
                                        <a href="#" class="text-muted text-hover-primary font-weight-bold">{{$employees->address}}</a>
                                    </div>
                                </div>
                                <!--end::Contacts-->
                                <!--begin::Nav-->
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <h5 class="font-weight-bold mb-6">QR CODE</h5>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-xl-3 col-lg-3 col-form-label text-right"></label>
                                            <div class="col-lg-9 col-xl-6">
                                            <div class="symbol-label">    <img src="{{ $employees->qr_path }}" class="img-thumbnail max-w-450px" /> </div>
